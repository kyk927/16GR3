 ...
 * 
 */
package com.qhit.lh.gr3.kyk.t6.dao.impl;
...
import com.qhit.lh.gr3.kyk.t6.dao.BaseDao;
import com.qhit.lh.gr3.kyk.t6.utils.HibernateSessionFactory;

/**
 * @author 库悦凯 TODO 2017年12月11日上午9:55:06
 */
public class BaseDaoImpl implements BaseDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qhit.lh.gr3.kyk.t2.dao.BaseDao#getObjectById(java.lang.Object,
	 * int)
	 */
	@Override
	public Object getObjectById(Class clas, int id) {
		...
		Transaction ta = session.beginTransaction();
		// 获取id
		Object object = session.get(clas.getClass(), id);
		// 提交事务
		ta.commit();
		// 释放资源
		HibernateSessionFactory.closeSession();
