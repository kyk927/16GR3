	...
	<div class="main">
		...
		<form id="form1" method="post" action="user?cmd=uploadPic" enctype="multipart/form-data">
			<div class="content">
				...
				<tr>
					...
					class="text" id="userAge"/> 
					<font color="red">*</font></td>
				</tr>
				<tr>
					<td class="field">用户电话：</td>
					<td><input type="text" name="telephone" 
					class="text" id="telephone"/> 
					<font color="red">*</font></td>
				...
				<tr>
					...
					<td><input type="radio" name="type" id="type" 
					value="1" checked="checked"/>普通用户
		...
		<div class="buttons">
			...
			class="input-button" onclick="checkForm();"/>
			  ...
			  onclick="window.location='jsp/userAdd.jsp';" value="返回" class="input-button"/> 
		</div>
